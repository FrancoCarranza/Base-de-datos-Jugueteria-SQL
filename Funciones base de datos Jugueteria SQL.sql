...
/* Creamos la primera funcion que servira para traer el stock total del juguete que le digamos,
...
/* Agregamos la sexta funcion la cual servira para traer el precio de un juguete, como parameto le pasamos el id del juguete,
